...
SAVED.Metrics.From_Baseline = handles.From_Baseline;
SAVED.Metrics.To_Baseline = handles.To_Baseline;
SAVED.Metrics.Resilience = handles.Resilience;
SAVED.Metrics.Baseline_resilience = handles.Baseline_resilience;
SAVED.Metrics.Betweenness = handles.Betweenness;
SAVED.Metrics.kin = handles.kin;
SAVED.Metrics.kout = handles.kout;
...
[~,~,handles.ViolinCounts] = MakeViolin(tmp_toplot,...
    handles.ViolinCounts,leg_viol,'Resilience [-]',handles.PopColor,handles.n_datasets,handles.K);
...
[~,~,handles.ViolinCountsFrac] = MakeViolin(tmp_toplot,...
    handles.ViolinCountsFrac,leg_viol,'kin [-]',handles.PopColor,handles.n_datasets,handles.K);
...
[~,~,handles.ViolinNumber] = MakeViolin(tmp_toplot,...
    handles.ViolinNumber,leg_viol,'kout [-]',handles.PopColor,handles.n_datasets,handles.K);
...
try
    ...
    [~,~,handles.ViolinDuration] = MakeViolin(tmp_toplot,...
        handles.ViolinDuration,leg_viol,'Betweenness [-]',handles.PopColor,handles.n_datasets,handles.K);
